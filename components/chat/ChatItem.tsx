...
export const ChatItem = ({
    ...
    const canDeletetMessage = !deleted && (isAdmin || isModerator || isOwner);
  ...
  return (
    ...
    <div className="relative group flex items-center hover:bg-black/5 p-4  transition w-full ">
        ...
        {canDeletetMessage && (
            <div className="hidden group-hover:flex items-center gap-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-md">
                {canEditMessage && (
